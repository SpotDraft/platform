...
/** @hidden */
export declare const resolveToFunctionSelector: <RootState, S>(selector?: Selector<RootState, S>) => ((s: RootState) => S) | ((state: RootState) => RootState) | ((state: RootState) => any) | ((state: any) => any);
